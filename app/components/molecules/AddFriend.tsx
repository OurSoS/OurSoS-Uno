...
const checkIfUserExists = async (deviceId: string): Promise<boolean> => {
  await axios
    .post(`https://oursos-backend-production.up.railway.app/users/${deviceId}`)
    .then((res) => {
...
const updateUser = async (
  ...
  try {
    const response = await axios.put(
      `https://oursos-backend-production.up.railway.app/updateuser/${id}`,
      {
        id,
        deviceId,
        username,
