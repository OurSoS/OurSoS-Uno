  ...
  return (
    <>
      ...
      >
        <View
          style={tw.style(
            `flex flex-row items-center justify-center mt-5 ml-4 h-8 w-20 bg-white rounded-lg border border-gray-300 shadow-md`
          )}
        >
          <Link href="./settings">
            <Text style={tw.style(`text-[1rem] text-center`)}>
              <Text style={tw.style(`text-black font-bold`)}>{"<  "}</Text>
              Back
            </Text>
          </Link>
        </View>
