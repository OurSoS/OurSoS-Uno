...
export default function UpdateProfile() {
      ...
      const updateProfile = async () => {
            ...
            await axios.get(`https://oursos-backend-production.up.railway.app/users/${getDeviceId()}`)
                  ...
                  .then(async (user) => {
                        await axios.post("https://oursos-backend-production.up.railway.app/uploadimage", {
                              "imagefile": `data:image/png;base64,${image}`
                        }).then(async (res) => {
                              fetch(`https://oursos-backend-production.up.railway.app/updateuser/${user?.id}`, {
                                    method: 'PUT',
                                    headers: {
            ...
            >
                  <ScrollView style={
                        ...
                        >
                              {
                                    !profilePic && !image ?
                                          <Image
                                                ...
                                                source={imgsrc} alt="" width={100} height={100}
                                          />
                                          : image
                                                ? <Image
                        ...
                        <View
                              ...
                              >
                                    <Text
                                          style={tw.style(`text-black mx-auto text-md`)}>
                                          Update Image
                                    </Text>
                              </Pressable>
                        ...
                        >
                              <Text
                                    style={tw.style(`text-white mx-auto text-xl`)}>
                                    Done
                              </Text>
                        </Pressable>
                  </ScrollView>
